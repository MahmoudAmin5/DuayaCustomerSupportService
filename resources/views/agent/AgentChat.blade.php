...
<html>
    ...
    <script src="{{ asset('ChatManagerAgent.js') }}"></script>
    <style>
    ...
    <body class="min-h-screen gradient-bg p-4">
        <div class="flex items-center justify-center min-h-screen">
            <div class="glass-effect shadow-2xl rounded-3xl w-full max-w-4xl flex flex-col h-[85vh] overflow-hidden">
                ...
                <!-- Enhanced Header -->
                <div
                    class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl font-semibold">{{ $chat->agent ? $chat->customer->name : 'Customer' }}
                            </h2>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div id="connection-status"
                            class="flex items-center bg-white bg-opacity-20 rounded-full px-3 py-1">
                ...
                <div id="messages"
                    ...
                    <div class="space-y-4">
                                    ...
                                    <div
                                        ...
                                        @elseif($message->type === 'file')
                                            <a href="{{ asset('storage/' . $message->file_path) }}"
                                                ...
                                                <div>
                                                    <p class="text-sm font-medium">{{ $message->content ?? 'Download File' }}
                                                    </p>
                                        ...
                                        <div class="flex items-center space-x-2 text-xs text-gray-500">
                                            ...
                                            @if($message->sender_id == $sender_id)
                                                <span id="message-status-{{ $message->id }}"
                                                    class="message-status text-blue-500">
                        ...
                        <div id="typing-indicator" class="flex justify-start hidden message-bubble">
                            <div
                                class="bg-white border border-gray-200 rounded-r-2xl rounded-tl-2xl px-5 py-3 shadow-lg">
